    ...
    >
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-10 md:flex-row md:items-start md:justify-between">
        <div className="text-center md:text-left">
          ...
          <p className="mt-2 max-w-md font-(--font-inter) text-sm text-(--color-text-muted)">
            En primer Eroscape Room Iónico del mundo. Próximamente App y QR Dinámico.
          </p>
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:flex-wrap sm:justify-center md:justify-start">
            <Link
              ...
              className="inline-block rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-[color-mix(in_srgb,var(--color-magenta)_55%,transparent)] focus-visible:ring-offset-2 focus-visible:ring-offset-(--color-bg-base)"
        ...
        >
          <p className="font-(--font-jetbrains) text-[10px] tracking-[0.2em] text-(--color-text-muted)">QR (demo)</p>
          <div className="mt-4 inline-block rounded-xl bg-white p-3">
            <AppMovilPlaceholderQr className="block focus:outline-none focus-visible:ring-2 focus-visible:ring-[color-mix(in_srgb,var(--color-magenta)_55%,transparent)] focus-visible:ring-offset-2 focus-visible:ring-offset-(--color-bg-elevated)" />
          </div>
        </div>
      </div>
    </section>
